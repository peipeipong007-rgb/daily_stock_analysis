...
class Config:
    ...
    "2317.TW",  # 鴻海（GB200 AI伺服器龍頭）
    "2382.TW",  # 廣達（AI伺服器核心代工廠）
    "3231.TW",  # 緯創（AI伺服器基板主要供應商）
    "3017.TW",  # 奇鋐（AI伺服器 3D VC / 液冷散熱龍頭）
    "3324.TW",  # 雙鴻（水冷散熱關鍵廠商）
    "3661.TW",  # 世芯-KY（AI ASIC 矽智財股王）

    # --- 電力與重電概念股（強韌電網、變壓器、綠能） ---
    "1519.TW",  # 華城（重電外銷美洲龍頭、變壓器王者）
    "1503.TW",  # 士電（重電三雄、與台電強韌電網計畫核心）
    "1513.TW",  # 中興電（GIS 氣體絕緣開關唯一獲台電認證，訂單爆滿）
    "1514.TW",  # 亞力（高低壓配電盤、半導體廠建廠電力設備）
    "1605.TW",  # 華新（電線電纜龍頭、受惠電力基礎建設）
    "2308.TW",  # 台達電（電源供應器龍頭、切入AI電力與儲能）
    "6806.TW"   # 森崴能源（綠能、離岸風電與儲能指標）
])
